...
(hh = h / 2),
  (opts = {
    ...
    fireworkBaseReachTime: 100,
    fireworkAddedReachTime: 100,
    ...
    gravity: 0.1,
    upFlow: -0.1,
    letterContemplatingWaitTime: 760,
    balloonSpawnTime: 100,
    balloonBaseInflateTime: 60,
    balloonAddedInflateTime: 60,
    balloonBaseSize: 20,
    balloonAddedSize: 20,
    balloonBaseVel: 0.4,
    balloonAddedVel: 0.4,
...
Letter.prototype.step = function () {
  if (this.phase === "firework") {
    ...
    if (this.tick > opts.letterContemplatingWaitTime) {
      ...
      this.vx = Math.cos(rad) * vel * 0.05;
      this.vy = Math.sin(rad) * vel * 0.05; 
    }
...
document.getElementById("goToPageButton").addEventListener("click", function() {
  window.location.href = "../hbd/xixi.html"; 
});
